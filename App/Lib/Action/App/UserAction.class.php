    ...
    class UserAction extends AppAction
    {
         ...
         */
         public function myinfo()
         {
             ...
             $minfo['headPic']=get_avatar($this->uid);
             $result['minfo']=$minfo;
             ajaxmsg($result,0);
         }
		...
		*/
        ...
        public function msg()
        {
            ...
            if($id){
                ...
                $p = new Page($count, 15);
                $page = $p->show();
                $pager['total']=ceil($count/15);
                $pager['nowPage'] = isset($_REQUEST['p'])?$_REQUEST['p']:1;
		...
		public function loan()
         {
            ...
            $list['page']['total']==0&&ajaxmsg("你目前没有借款纪录");
		 ...
		 public function loaninvest()
         {
            ...
            $list['page']['total']==0&&ajaxmsg("你目前没有投资纪录");
			if(($list['page']['nowPage']>$list['page']['total'])||!$list|!$list['list'])
                ajaxmsg("没有数据",1);
            else ajaxmsg($list,0);    
