...
$acl_inc[$i]['low_leve']['loan'] = array("借款发布" => array(
        "查看" => "atjb1",
		"验证用户名" =>"br2",
		"发布" =>"br15",
    ),
    ...
    "data" => array(
        //网站设置
		'eqaction_publish' => 'atjb1',
		'eqaction_verifyname' => 'br2',
		'eqaction_dopublish' => 'br15',
		'eqaction_doflow' => 'br15',
		...
		'eqaction_transferring' => 'br7',
		'eqaction_repaylist' => 'br7',
		'eqaction_repay' => 'br15',
        'eqaction_dorepay' => 'br15',
		...
		'eqaction_schedule' => 'br15',
		'eqaction_doschedule' => 'br15',
		'eqaction_downagreement' => 'br15',
		'eqaction_huakuan' => 'br15',
		'eqaction_dohuakuan' => 'br15',
		'eqaction_depositverify' => 'br15',
		'eqaction_dodepositadd' => 'br15',
		'eqaction_qingsuan' => 'br15',
		'eqaction_doqingsuan' => 'br15',
...
$i++;
$acl_inc[$i]['low_title'][] = '房源管理';
$acl_inc[$i]['low_leve']['house'] = array("房源列表" => array(
        "列表" => 'me1',
        '审核' => 'me2',
    ),
    "data" => array(
...
$acl_inc[$i]['low_title'][] = '房源地管理';
$acl_inc[$i]['low_leve']['area'] = array("房源地列表" => array(
        "列表" => 'area1',
        "编辑" => 'area2',
        "添加" => 'area3',
        "批量添加" => 'area4',
    ...
    "data" => array(
        //网站设置
        'eqaction_index' =>'area1',
        'eqaction_edit' =>'area2',
        'eqaction_doedit' =>'area2',
        'eqaction_add' =>'area3',
        'eqaction_doadd' =>'area3',
        'eqaction_dodel' =>'area3',
        'eqaction_listtype' =>'area3',
        'eqaction_addmultiple' =>'area4',
