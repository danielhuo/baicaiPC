...
class MsgonlineAction extends ACommonAction
{
    ...
    */
    public function index()
    {
		...
		$type = $msgconfig['sms']['type'];// type=0 吉信   type=1 漫道  type=2 亿美 type=3 云通讯
		...
		if($type==0){
			...
			//if($result!= NULL && $result->statusCode==0) { 
				 ...
				 $this->assign('ytx',"￥".$account->balance);
			//}
		...
		$this->assign("type_list", array("4"=>'关闭短信平台服务',"1"=>'漫道短信提供商',"2"=>'亿美软通短信提供商',"0"=>'吉信通短信提供商',"3"=>'云通讯短信提供商'));
        $this->display();
    }
