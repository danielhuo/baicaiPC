...
<body>
<div class="container">
    <form class="form-horizontal" action="__URL__/doedit">
        ...
        <div class="form-group ">
            <label class="control-label col-xs-2">格局</label>
            <div class="col-xs-10">
                <div class="input-group col-xs-5">
        ...
        <div class="form-group ">
            ...
            <div class="col-xs-10">
                <div class="input-group col-xs-5">
                <input type="number" class="form-control" name="bed_room" value="<?php echo ($house["xian"]); ?>">
                <span class="input-group-addon">-</span>
                <input type="number" class="form-control" name="live_room" value="<?php echo ($house["zhen"]); ?>">
                <span class="input-group-addon">-</span>
                <input type="number" class="form-control" name="toilet" value="<?php echo ($house["village"]); ?>">
                <span class="input-group-addon">-</span>
                </div>
            </div>
        </div>
